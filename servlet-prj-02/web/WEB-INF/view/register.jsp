...
<form action="${pageContext.request.contextPath}/register" class="form-signin" method="post" onsubmit="return verify()">
    <div class="text-center mb-4">
        ...
        <p style="color: gray">
            已有帐号？
            <a style="color: blue" href="${pageContext.request.contextPath}/login">登录</a>
        </p>
    </div>
    ...
    <div class="form-label-group">
        ...
        <input type="date" id="birthday" class="form-control" name="birthday" required max="2200-12-30">
    </div>
