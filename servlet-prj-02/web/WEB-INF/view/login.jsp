...
<form class="form-signin" method="post" action="${pageContext.request.contextPath}/login">
    ...
    <div class="form-label-group">
        ...
        <input type="text" id="username" class="form-control" placeholder="请输入用户名" name="username" maxlength="10" required value="${requestScope.rememberUsername}">
    </div>

    <div class="form-label-group">
        <label for="password">密码：</label>
        <input type="password" id="password" class="form-control" placeholder="请输入密码" name="password" minlength="6" maxlength="16" required value="${requestScope.rememberPassword}">
    </div>
